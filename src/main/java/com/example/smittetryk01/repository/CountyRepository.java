...
public interface CountyRepository extends JpaRepository<County, String> {
    ...
    Optional<County> findByHref(String href);
    ...
    List<County> findByNameIsLike(String name);

    List<County> findCountyByRegion(Region region);

    List<County> findCountyByRegionRegionCode(String regionCode);
